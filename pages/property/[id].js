...
const PropertyDetails = ({ PropertyDetails: { price, rentFrequency, rooms, baths, title, agency, area, isVerified, description, type, purpose, furnishingStatus, amenities, photos } }) => (
